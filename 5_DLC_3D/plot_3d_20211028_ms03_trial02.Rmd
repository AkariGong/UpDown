...
```{r}
filename <- here('20211028_ms03_trial02_DLC_3D.csv')
```
...
data_peaks_1 <- data_peaks %>% 
  subset(frame >= 130 & frame <= 330) # create a subset by matching the range of frame numbers with qualitative analysis
...
write_csv(data_nojumps_plot, "20211028_ms03_trial02_3dtail.csv")
```
