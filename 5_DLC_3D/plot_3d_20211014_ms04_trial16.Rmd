...
```{r read data}
filename <- here('20211014_ms04_trial16_DLC_3D.csv')
```
...
data_peaks_1 <- data_peaks %>% 
  subset(frame >= 230 & frame <= 610) # create a subset by matching the range of frame numbers with qualitative analysis
...
write_csv(data_nojumps_plot, "20211014_ms04_trial16_3dtail.csv")
```
