...
```{r read data}
filename <- here('20211014_ms04_trial04_DLC_3D.csv')
```
...
data_peaks_1 <- data_peaks %>% 
  subset(frame >= 200 & frame <= 570) # create a subset by matching the range of frame numbers with qualitative analysis
...
write_csv(data_nojumps_plot, "20211014_ms04_trial04_3dtail.csv")
```
