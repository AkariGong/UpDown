...
```{r read data}
filename <- here('20211014_ms04_trial05_DLC_3D.csv')
```
...
data_peaks_1 <- data_peaks %>% 
  subset(frame >= 640 & frame <= 1080) # create a subset by matching the range of frame numbers with qualitative analysis
...
ccf(data_nojumps_phase$dorsal_lobe, data_nojumps_phase$ventral_lobe, lag = 80, pl = T)
...
write_csv(data_nojumps_plot, "20211014_ms04_trial05_3dtail.csv")
```
