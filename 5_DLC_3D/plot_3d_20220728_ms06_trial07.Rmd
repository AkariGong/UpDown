...
filename <- here('/Users/minggong/Documents/Tytell_Lab/Project2/Code/DLC_3D_analysis/DLC_3D_bad/20220728_ms06_trial07_DLC_resnet50_UpAndDownRear4Feb10shuffle1_500000.csv')
```
...
data_nojumps <-
  data_long %>%
  dplyr::filter(bodypart != "left_eye") %>%  # There is no data for "left_eye", filter out this body part to debug
  group_by(bodypart) %>%
...
ifelse(file.exists("20220728_ms06_trial07_3dtail.csv"), 
       yes = askYesNo("Do you want to continue? Check file name!"), 
       no = write_csv(data_nojumps_plot, "20220728_ms06_trial07_3dtail.csv"))
```
