...
```{r}
filename <- here('20211029_ms05_trial01_DLC_3D.csv')
```
...
data_peaks_1 <- data_peaks %>% 
  subset(frame >= 85 & frame <= 600) # create a subset by matching the range of frame numbers with qualitative analysis
...
ifelse(file.exists("20211029_ms05_trial01_3dtail.csv"), yes = askYesNo("Do you want to continue? Check file name!"), no = write_csv(data_nojumps_plot, "20211029_ms05_trial01_3dtail.csv"))
```
