...
```{r}
filename <- here('20211013_ms03_trial04_DLC_3D.csv')
```
...
data_peaks_1 <- data_peaks %>% 
  subset(frame >= 395 & frame <= 811) # create a subset by matching the range of frame numbers with qualitative analysis
data_peaks_1 <- data_peaks_1[-c(7, 8, 9, 10, 14, 15, 17, 18, 19),] # Remove certain rows if needed. The final data frame should have 12 rows, which means 3 tail beats.

# write_csv(data_peaks_1, "3d_20211013_ms03_trial04.csv")
...
write_csv(data_nojumps_plot, "20211013_ms03_trial04_3dtail.csv")
```
