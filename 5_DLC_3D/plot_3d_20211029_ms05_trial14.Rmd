...
```{r read data}
filename <- here('20211029_ms05_trial14_DLC_3D.csv')
```
...
ifelse(file.exists("20211029_ms05_trial14_3dtail.csv"), yes = askYesNo("Do you want to continue? Check file name!"), no = write_csv(data_nojumps_plot, "20211029_ms05_trial14_3dtail.csv"))
```
