...
```{r}
filename <- here('20211013_ms03_trial02_DLC_3D.csv')
```
...
data_peaks_1 <- data_peaks %>% 
  subset(frame >= 160 & frame <= 550) # create a subset by matching the range of frame numbers with qualitative analysis
data_peaks_1 <- data_peaks_1[-c(1,2,14,15,17),] # Remove certain rows if needed. The final data frame should have 12 rows, which means 3 tail beats.

# write_csv(data_peaks_1, "3d_20211013_ms03_trial02.csv")
...
write_csv(data_nojumps_plot, "20211013_ms03_trial02_3dtail.csv")
```
