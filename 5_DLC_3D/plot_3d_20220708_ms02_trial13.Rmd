...
filename <- here('/Users/minggong/Documents/Tytell_Lab/Project2/Code/DLC_3D_analysis/20220708_ms02_trial13_DLC_resnet50_UpAndDownRear4Feb10shuffle1_500000.csv')
```
...
ifelse(file.exists("20220708_ms02_trial13_3dtail.csv"), 
       yes = askYesNo("Do you want to continue? Check file name!"), 
       no = write_csv(data_nojumps_plot, "20220708_ms02_trial13_3dtail.csv"))
```
