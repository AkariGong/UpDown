...
filename <- here('/Users/minggong/Documents/Tytell_Lab/Project2/Code/DLC_3D_analysis/20220729_ms06_trial01_DLC_3D.csv')
```
...
ifelse(file.exists("20220729_ms06_trial01_3dtail.csv"), 
       yes = askYesNo("Do you want to continue? Check file name!"), 
       no = write_csv(data_nojumps_plot, "20220729_ms06_trial01_3dtail.csv"))
```
