...
lateral_angle <- read_csv("/Users/minggong/Documents/Tytell_Lab/Project2/Data/UpAndDownLateral3/videos/angle_vertv_data/lateral_angle_20211029_ms05.csv")
...
write_csv(alldata, '20211029_ms05_part2.csv')
