...
```{r}
filename <- here('20211013_ms03_trial13_DLC_3D.csv')
```
...
data_peaks_1 <- data_peaks %>% 
  subset(frame >= 180 & frame <= 683) # create a subset by matching the range of frame numbers with qualitative analysis
...
write_csv(data_nojumps_plot, "20211013_ms03_trial13_3dtail.csv")
```
