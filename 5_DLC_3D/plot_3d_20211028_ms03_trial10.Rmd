...
```{r read data}
filename <- here('20211028_ms03_trial10_DLC_3D.csv')
```
...
data_peaks_1 <- data_peaks %>% 
  subset(frame >= 40 & frame <= 370) # create a subset by matching the range of frame numbers with qualitative analysis
...
ifelse(file.exists("20211028_ms03_trial10_3dtail.csv"), yes = askYesNo("Do you want to continue? Check file name!"), no = write_csv(data_nojumps_plot, "20211028_ms03_trial10_3dtail.csv"))
```
